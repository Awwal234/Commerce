      ...
      <div class="flex flex-col md:gap-20 gap-10">
        ...
        <form @submit.prevent="login" class="flex flex-col">
          <input type="email" placeholder="Enter your email address"
            class="rounded-3xl w-[300px] md:w-[500px] md:m-5 m-2 p-4 placeholder-gray-300" id="email" v-model="email" />
          <input type="password" v-model="password"
            class="rounded-3xl w-[300px] md:w-[500px] md:m-5 m-2 p-4 placeholder-gray-300" id="password"
            placeholder="**********" />
          <button type="submit" class="bg-black text-white w-[300px] md:w-[500px] p-4 rounded-3xl md:m-5 m-2"
            @click="login">
            Login
          </button>
          <p>
